...
function App() {
  ...
  const contentClass = isCrt
    ...
    : isPlain
    ? "relative z-[1] px-6 py-10 text-gray-900 text-base leading-relaxed"
  ...
  const cogClass = isCrt
    ...
    : "border-[rgba(192,204,194,0.65)] bg-black text-[#cdd4ce] shadow-none hover:bg-[rgba(20,20,20,0.9)] focus-visible:outline-[#cdd4ce]";

  const modalPanelClass = isCrt
    ? "border-[rgba(168,255,181,0.75)] bg-[rgba(2,8,3,0.98)] text-[#a8ffb5] shadow-[0_0_0.5rem_rgba(112,255,137,0.35)]"
    : isPlain
  ...
  const optionClass = (id: DisplayMode): string => {
    ...
    if (isCrt)
      return selected
        ? "border-[#a8ffb5] bg-[#a8ffb5] text-black"
        : "border-[rgba(168,255,181,0.4)] hover:border-[#a8ffb5]";
    if (isPlain)
      return selected
  ...
  const closeBtnClass = isCrt
    ? "border-[rgba(168,255,181,0.4)] text-[#a8ffb5]/60 hover:border-[#a8ffb5] hover:text-[#a8ffb5]"
    : isPlain
